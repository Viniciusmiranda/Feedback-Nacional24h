...
PASS = "12f46g63H:)"
# Command: Stash changes (safety), Pull, Migrate (Schema change check), Restart
CMD = "cd /srv/app-avaliaja && git stash && git pull && echo '12f46g63H:)' | sudo -S docker compose restart"
